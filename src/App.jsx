    ...
    <div style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', height: '100vh', width: '100vw', overflow: 'hidden', position: 'relative' }}>
      ...
      >
        ...
        <div style={{ padding: 'var(--space-4)', borderTop: '1px solid var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '8px' }}>
          ...
          <span style={{ fontSize: '10px', fontWeight: '800', color: 'var(--text-tertiary)', backgroundColor: 'var(--background)', padding: '2px 6px', borderRadius: '4px', border: '1px solid var(--border)', letterSpacing: '0.5px' }}>v1.03</span>
        </div>
      </aside>
      ...
      <div className="login-container">
        ...
        <div className="login-card">
          ...
          <div className="login-footer" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
            ...
            <span style={{ fontSize: '10px', fontWeight: '600', color: 'rgba(255, 255, 255, 0.4)', marginTop: '2px' }}>v1.03</span>
          </div>
        </div>
      </div>
    )
