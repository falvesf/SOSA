        ...
        <header style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div>
              ...
              <span style={{ fontSize: '10px', color: 'var(--text-muted)' }}>Central de Ajuda Interna e Especificações do Sistema • v1.03</span>
            </div>
          </div>
          <button
            onClick={onClose}
...
- Preserve a sensibilidade humana original do coordenador.`}
        ...
        <footer style={{
          ...
          <span style={{ fontWeight: 'bold' }}>Revisão Técnica v1.03</span>
        </footer>
      </div>
    </div>
  );
